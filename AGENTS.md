...
Before migrating product documentation, search `simplexidev/sdeveng` consumers.
...
explain methods and link to the metrics site, but implementation, data, and presentation
stay in their respective `simplexidev/sdeveng-metrics-*` repositories.
