...
| Evaluator, scenarios, schemas, sanitized public data, dashboard, and Pages workflow | `codex-toolkit-metrics` | Offline measurement and public dashboard publication | Keep implementation and data in metrics; explain method and interpretation in [metrics](metrics/index.md). |
| Installation, use, configuration, architecture, security, examples, and contributor guidance | `codex-toolkit-docs` | Human readers only | This repository is never loaded by the runtime. |
